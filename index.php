...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <a href="#collapseCardObjective" class="d-block card-header py-3" data-toggle="collapse" role="button"
            aria-expanded="true" aria-controls="collapseCardObjective">
    ...
    <div class="card shadow mb-4">
        <!-- Card Header - Accordion -->
        <a href="#collapseCardResponsibilities" class="d-block card-header py-3" data-toggle="collapse" role="button"
            aria-expanded="true" aria-controls="collapseCardResponsibilities">
    ...
    <div class="card shadow mb-4">
        <!-- Card Header - Accordion -->
        <a href="#collapseCardInventoryRecord" class="d-block card-header py-3" data-toggle="collapse" role="button"
            aria-expanded="true" aria-controls="collapseCardInventoryRecord">
    ...
    <div class="card shadow mb-4">
        <!-- Card Header - Accordion -->
        <a href="#collapseCardStockControl" class="d-block card-header py-3" data-toggle="collapse" role="button"
            aria-expanded="true" aria-controls="collapseCardStockControl">
    ...
    <div class="card shadow mb-4">
        <!-- Card Header - Accordion -->
        <a href="#collapseCardInventoryRotation" class="d-block card-header py-3" data-toggle="collapse" role="button"
            aria-expanded="true" aria-controls="collapseCardInventoryRotation">
            <h6 class="m-0 font-weight-bold text-primary">VI. Rotación de inventario</h6>
        </a>
        <!-- Card Content - Collapse -->
    ...
    <div class="card shadow mb-4">
        <!-- Card Header - Accordion -->
        <a href="#collapseCardStaffResponsibility" class="d-block card-header py-3" data-toggle="collapse" role="button"
            aria-expanded="true" aria-controls="collapseCardStaffResponsibility">
            <h6 class="m-0 font-weight-bold text-primary">VII. Responsabilidad del personal</h6>
        </a>
        <!-- Card Content - Collapse -->
    ...
    <div class="card shadow mb-4">
        <!-- Card Header - Accordion -->
        <a href="#collapseCardRegulation" class="d-block card-header py-3" data-toggle="collapse" role="button"
            aria-expanded="true" aria-controls="collapseCardRegulation">
            <h6 class="m-0 font-weight-bold text-primary">VIII. Modificaciones al reglamento</h6>
        </a>
        <!-- Card Content - Collapse -->
    ...
    <div class="card shadow mb-4">
        <!-- Card Header - Accordion -->
        <a href="#collapseCardSecurity" class="d-block card-header py-3" data-toggle="collapse" role="button"
            aria-expanded="true" aria-controls="collapseCardSecurity">
            <h6 class="m-0 font-weight-bold text-primary">IV. Seguridad del inventario</h6>
        </a>
        <!-- Card Content - Collapse -->
    ...
    <div class="card shadow mb-4">
        <!-- Card Header - Accordion -->
        <a href="#collapseCardIrregulation" class="d-block card-header py-3" data-toggle="collapse" role="button"
            aria-expanded="true" aria-controls="collapseCardIrregulation">
            <h6 class="m-0 font-weight-bold text-primary">X. Resolución de discrepancias</h6>
        </a>
        <!-- Card Content - Collapse -->
    ...
    <div class="card shadow mb-4">
        <!-- Card Header - Accordion -->
        <a href="#collapseCardTraining" class="d-block card-header py-3" data-toggle="collapse" role="button"
            aria-expanded="true" aria-controls="collapseCardTraining">
            <h6 class="m-0 font-weight-bold text-primary">XI. Capacitación del personal</h6>
        </a>
        <!-- Card Content - Collapse -->
